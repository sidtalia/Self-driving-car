...
Servo motor,steer;
#define dt 0.0025
#define MAX_ACCELERATION 7.07 // max sideways acceleration is 10/root(2) m/s*s
...
//  c[4].setcordsO(0.0,0.0);
  ...
  c[0].slope = mh; //initial slope is the same as initial heading.
  n = 8;
  generate_Slopes();
  c[7].slope = c[6].slope = mh; //defining it randomly for now.
